...
export const pagenation = () => {
    ...
    if(document.getElementById('pageVORealEnd').value != 0) {
        ...
        pageNumberOne.addEventListener('click', () => {
            location.href = contextPath + '/board/dress?page=1&amount=' + amount + '&category=' + category
                                                + '&listType=' + listType + '&searchType=' + encodeURIComponent(searchType)
                                                + '&searchName=' + encodeURIComponent(searchName);
        });
        ...
        if(pageStart_v != false && pageEnd_v != false ) {
            pageStart.addEventListener('click', () => {
                location.href =  contextPath + '/board/dress?page=' + pageStart_v
                                                + '&amount=' + amount + '&category=' + category
                                                + '&listType=' + listType + '&searchType=' + encodeURIComponent(searchType)
                                                + '&searchName=' + encodeURIComponent(searchName);
            });
            ...
            pageNext.addEventListener('click', () => {
                location.href =  contextPath + '/board/dress?page=' + pageEnd_v
                                                + '&amount=' + amount + '&category=' + category
                                                + '&listType=' + listType + '&searchType=' + encodeURIComponent(searchType)
                                                + '&searchName=' + encodeURIComponent(searchName);
            });
...
export const pagenationNumber = () => {
    ...
    document.querySelectorAll('.pageNumber').forEach((anchor, index) => {
        ...
        anchor.addEventListener('click', () => {
            // URL 변경 및 CSS 설정
            location.href = contextPath + '/board/dress?page=' + pageNum +  '&amount=' + amount + '&category=' + category
